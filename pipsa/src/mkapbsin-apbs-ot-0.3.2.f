...
c----------------------------------------------------------------------
c
c This is for apbs versions older than 0.3.2
c corrects for apbs problem in writing uhbd grid origin
c (this problem corrected in apbs version >= 0.3.2)
c
...
c. get spacing from dime and glen to shift center 
 810  continue
      ...
      goto 810
 820  continue
      spx=eapbsx/float(napbsx-1)
      xa=xa-spx
      spy=eapbsy/float(napbsy-1)
      ya=ya-spy
      spz=eapbsz/float(napbsz-1)
      za=za-spz
      rewind(81)
c
