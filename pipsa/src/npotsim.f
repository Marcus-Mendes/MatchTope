...
c
      include "maxdim.inc"
      character*1024 pname,fname,lname,fparts,fpdbs,arg
      character*1024 command,dum
      character*1 s
      character*1024 ns(nprmx)
      character*1024 target
...
c
      ...
      write(6,499)
 499  format('usage: npotsim -pg program -fn fname -lg lname ',
...
c      open(12,file=lname)
      open(12,file=lname,position='APPEND')
c 121  continue
c      read(12,'(a)',end=122) s
c      goto 121
c 122  continue
